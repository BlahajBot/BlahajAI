...
class TestPluginDispatch:
    ...
    def test_dispatch_passes_optional_input_image_to_provider(self, monkeypatch, tmp_path):
        from tools import image_generation_tool
        from agent import image_gen_registry as registry_module
        from hermes_cli import plugins as plugins_module
        ...
        assert payload["success"] is True
        assert payload["input_image"] == "/tmp/reference.png"

    def test_dispatch_passes_optional_quality_to_provider(self, monkeypatch, tmp_path):
        from tools import image_generation_tool
        from agent import image_gen_registry as registry_module
        from hermes_cli import plugins as plugins_module
    ...
    def test_dispatch_rejects_invalid_quality(self, monkeypatch, tmp_path):
        from tools import image_generation_tool
        ...
        assert "quality" in payload["error"]
