...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        # Register skills under a single flat /skill command with autocomplete.
        # Can be disabled for deployments where the native slash-command payload
        # or permissions rollout is undesirable; built-in commands still register.
